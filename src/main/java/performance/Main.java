 ...
 */
public class Main {
    public static String devices = "a4dbaead";
    public static String packageName = "com.ss.android.ugc.aweme";
    public static String packageName1 = "com.ss.android";
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        for (int i = 0; i < 20; i++) {
            Double cpu = topCpu(packageName1);
            Double mem = talHeapSize(packageName1);
